...
to zero. ACI is targetted towards handling burst from AKS clusters, longer running containers, batch workloads and jobs. Therefore, the pricing model is different. On Cloud Run, you only pay while a request is being handled.
